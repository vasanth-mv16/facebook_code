...
public class UserView extends CommonView {
    ...
    public User.Gender getGender() {
        ...
        final User.Gender gender = User.Gender.setUserGender(getChoice());
    ...
    private void update(final Long id) {
        ...
        user.setName(userValidation.validateAccess(SCANNER.nextLine()) ? getName() : existingUser.getName());
        System.out.println("DO YOU WANT TO EDIT NAME, PRESS 'YES' OR 'Y' AND DON'T WANT TO EDIT PRESS ANY KEY ");
        user.setEmail(userValidation.validateAccess(SCANNER.nextLine()) ? getEmail() : existingUser.getEmail());
        System.out.println("DO YOU WANT TO EDIT NAME, PRESS 'YES' OR 'Y' AND DON'T WANT TO EDIT PRESS ANY KEY ");
        user.setPassword(userValidation.validateAccess(SCANNER.nextLine()) ? getPassword() : existingUser.getPassword());
        System.out.println("DO YOU WANT TO EDIT NAME, PRESS 'YES' OR 'Y' AND DON'T WANT TO EDIT PRESS ANY KEY ");
        user.setMobileNumber(userValidation.validateAccess(SCANNER.nextLine()) ? getMobileNumber() : existingUser.getMobileNumber());
     ...
     */
    private User get() {
        final User user = (userController.get(getUserId()));
